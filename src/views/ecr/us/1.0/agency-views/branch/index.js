...
const mapStateToProps = (state) => {
    return ({
        data: state && state.form && state.form.branch && state.form.branch.values,
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        saveEditBranchData: (data) => {
            dispatch(saveEditBranchData(data))
        }
    }
}
export const BranchScreen = connect(mapStateToProps, mapDispatchToProps)(Branch);