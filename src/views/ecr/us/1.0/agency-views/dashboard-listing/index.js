...
const mapStateToProps = (state) => {
    ...
    return ({
        listing: state.DashboardListingReducer.listing,
        selectedList: state.DashboardListingReducer.selectedListing,
        ...
        agencyViews: state && state.AgencyDashboardReducer && state.AgencyDashboardReducer.AnalyticData &&
            state.AgencyDashboardReducer.AnalyticData.totalsForAllResults &&
            state.AgencyDashboardReducer.AnalyticData.totalsForAllResults['ga:pageviews'] ? state.AgencyDashboardReducer.AnalyticData.totalsForAllResults['ga:pageviews'] : 0,
    });
}
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getVehicleInformation: (data, success, failure) => {
            dispatch(getVehicleInformation(data, success, failure))
        }
    }
}
...
export const DashboardListingScreen = connect(mapStateToProps, mapDispatchToProps)(reduxFormFunction);
